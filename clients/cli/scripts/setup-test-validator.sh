...
setup_test_validator() {
  solana-test-validator \
    --clone-upgradeable-program 8mYkiWJF23Znv77Erfck3cQvUPqttdGPxu2FmBAsfBS \
  ...
  #solana-test-validator \
  #  --bpf-program 8mYkiWJF23Znv77Erfck3cQvUPqttdGPxu2FmBAsfBS ../../../target/deploy/spl_stake_pool.so \
